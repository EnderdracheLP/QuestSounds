...
$LibsToLogError = "QuestHook[UtilsLogger`|v1.1.6]:E QuestHook[UtilsLogger`|v2.0.2]:E QuestHook[UtilsLogger`|v2.0.3]:E QuestHook[codegen`|v0.7.0]:E QuestHook[questui`|v0.5.0]:E"
$LibsToLogAll = "QuestHook[UtilsLogger`|v1.1.6]:* QuestHook[UtilsLogger`|v2.0.2]:* QuestHook[UtilsLogger`|v2.0.3]:* QuestHook[codegen`|v0.7.0]:* QuestHook[questui`|v0.5.0]:*"
...
adb logcat -T "$timestamp" main-modloader:W AndroidRuntime:E *:S $YourModsToLog $OtherModsToLog $LibsToLogError
        ...
        if ($args[0] -eq "--file") {
            ...
            $logger = Start-Job -Arg "$timestamp", $PSScriptRoot -scriptblock {
                ...
                adb logcat -v color -T "$timestamp" main-modloader:W libmodloader:W libmain:W AndroidRuntime:E QuestHook[UtilsLogger`|v2.0.3]:* QuestHook[`|v]:* QuestHook[streamer-tools`|v0.1.0]:* QuestHook[QuestSounds`|v0.3.0]:* QuestHook[QuestSounds`|v1.0.0]:* QuestHook[clockmod`|v1.4.0]:* *:S | Tee-Object -FilePath "$Path/logcat.log"
            }
