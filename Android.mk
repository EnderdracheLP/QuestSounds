...
LOCAL_MODULE := 
include $(CLEAR_VARS)
# Creating prebuilt for dependency: beatsaber-hook - version: 1.1.0
include $(CLEAR_VARS)
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp/' -DID='"QuestSounds"' -DVERSION='"0.3.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
