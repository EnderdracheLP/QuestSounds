...
DEFINE_CLASS(QuestSounds::NewAudioClipLoader);
...
bool QuestSounds::NewAudioClipLoader::load()
{
    //Stage 0 
...
void QuestSounds::NewAudioClipLoader::audioClipCompleted(loader* obj, Il2CppObject* asyncOp)
{
    // Stage 1
...
Il2CppObject* QuestSounds::NewAudioClipLoader::getClip()
{
